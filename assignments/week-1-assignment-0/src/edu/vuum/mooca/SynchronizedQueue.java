   ...
   public enum SynchronizedQueueResult {
    ...
    public static SynchronizedQueueResult testQueue(QueueAdapter<Integer> queue) {
        try {
        	...
        	try {
        		consumer.join(10000);	// lets give it a max of 10 seconds to wait for the threads to finish
        	}
        	catch (InterruptedException e)
        	{
        	...
        	// wait for producer
        	try {
        		producer.join(10000);	// lets give it a max of 10 seconds to wait for the threads to finish
        	}
        	catch (InterruptedException e)
        	{
        		Thread.currentThread().interrupt();
